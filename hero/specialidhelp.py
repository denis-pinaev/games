...
persons = [
              ...
              {"pid":"107738176","auth":"3194740fd9573509f0d3c523be6e4541","gid":0,"sid":""},#vadimbot5 25
              {"pid":"133569922","auth":"994c8cc961e087a786c64694c886fcaa","gid":0,"sid":""},#lenaSv_bot 26
...
if True:
    ...
    total = min(count_id, len(persons))
    while i<total:
        pers = persons[i]
        pid = pers['pid']
        auth = pers['auth']
