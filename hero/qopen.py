...
def openGift():
    ...
    service = 'Knights.doAction'
    method = 'recipeStart'
    
    init_params(nsid=sid, ngid=gid, nservice=service, nmethod=method)
    
    dataString = '{"count":1,"extra":1,"paidStart":false,"rid":1637297310,"index":"1637297310","type":"global","ctr":%s,"sessionKey":"%s","method":"%s"}' % (getCTR(),sid,method)
